...
public class SimDialogActivity extends Activity {
    ...
    private static void setDefaultDataSubId(final Context context, final int subId) {
        ...
        //add by hhj@20160718 for subId != SubscriptionManager.INVALID_SUBSCRIPTION_ID
        if (subId != SubscriptionManager.INVALID_SUBSCRIPTION_ID && !teleMgr.getDataEnabled(subId)) {
...
//                    return true;
        ...
        if (id == CALLS_PICK) {
            ...
            list.add(getResources().getString(R.string.ask_first));
          ...
          //add begin. by hhj@20160716 for add item "adk first" and "sim off"
            if(id == SMS_PICK){
                list.add(getResources().getString(R.string.ask_first));
            }else{
                list.add(getResources().getString(R.string.sim_off));
            }
            //add end.
            ...
            //add by hhj@20160716 for add item "adk first" and "sim off"
    ...
    private void setDefaltSubIdByDialogId(
        ...
        switch (dialogId) {
            case DATA_PICK:
                ...
                //add begin. hhj@20160718 for Determine whether the sir is null or not
                if(sir != null){
                    /* SPRD: add new feature for data switch on/off @{ */
                    ...
                    //add begin. hhj@20160718 for off
                    setDefaultDataSubId(context, SubscriptionManager.INVALID_SUBSCRIPTION_ID);
                    disableDataForOtherSubscriptions(context,SubscriptionManager.INVALID_SUBSCRIPTION_ID);
                    //add end.
                }
                //add end.
                break;
    ...
    private class SelectAccountListAdapter extends ArrayAdapter<String> {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            if (sir == null) {
                ...
                switch (mDialogId) {
                    case DATA_PICK:
                        //add begin. by hhj@20160716 for add adk first and sim off
                    ...
                    case CALLS_PICK:
                        ...
                        break;
                    case SMS_PICK:
                      //modify begin. by hhj@20160716 for add adk first and sim off
                        /*holder.defaultSubscription.setChecked(0 == position
                                && subscriptionManager.getDefaultSmsSubId()
